...
export function getBasicColumns(): BasicColumn[] {
  return [
    ...
    },
    {
      ...
      dataIndex: 'lotInfo.floor',
      format: (val) => val + t('component.carport.carport_floor_suffix')
    },
    {
      title: t('component.carport.carport_suffix'),
      dataIndex: 'lotInfo.lotNo',
      format: (val) => val + t('component.carport.carport_suffix')
    }
  ];
}
